            ...
            <div class="container">
                <div class="navbar-content">
                    ...
                    <ul class="nav-menu">
                        ...
                        <li><a href="contacto.php" class="active"><?php echo __('nav_contacto'); ?></a></li>
            ...
            <div class="container">
                <div class="contact-wrapper">
                    <div class="contact-info">
                        ...
                        <a href="pago.php?servicio=<?php echo urlencode($servicio_seleccionado); ?>" class="btn btn-primary btn-pagar">
                            <?php echo __('contacto_pagar_ahora'); ?>
                        </a>
                    </div>
